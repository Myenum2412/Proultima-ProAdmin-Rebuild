...
type TaskAllocationFormData = z.infer<typeof taskAllocationSchema>;
...
interface TaskAllocationProps {
  ...
  teams?: Team[];
  staffs?: Staff[];
  onSubmit?: (data: TaskAllocationFormData & { files: File[] }) => void;
}
...
export function TaskAllocation({
  ...
  const form = useForm<TaskAllocationFormData>({
    resolver: zodResolver(taskAllocationSchema),
    defaultValues: {
      taskTitle: "",
      repeatedSetting: undefined,
      assignType: "self",
      priority: undefined,
      selectedTeamIds: [],
      selectedStaffIds: [],
  ...
  const handleFormSubmit = (data: TaskAllocationFormData) => {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DialogDescription className="text-xs text-muted-foreground mt-0.5">
                  Assign a new task to teams or individual staff members.
                </DialogDescription>
              </div>
            </div>
            <DialogClose asChild>
              ...
              <div className="py-4 space-y-4">
                <div className="rounded-lg border border-primary/20 bg-primary/5 px-4 py-3">
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    Define the task by filling in all required fields below.
                  </p>
                </div>
